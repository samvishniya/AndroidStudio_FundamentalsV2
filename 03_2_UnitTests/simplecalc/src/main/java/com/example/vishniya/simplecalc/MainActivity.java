...
/*
Q1 A local unit test can be described as a test that is compiled entirely on your local machine with the JVM ,requiring no frameworks
Q2 A source set is a colection of related code, unit tests can be found in the com.example."xxx"."xxxxx" (test) source set
Q3 @Test is used to annotate a test
 */
