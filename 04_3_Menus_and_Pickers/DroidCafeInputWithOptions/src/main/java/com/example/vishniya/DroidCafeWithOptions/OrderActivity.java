...
//todo sort out text formatting for datepicker toast
...
displayToast(spinnerLabel);
    ...
    public void processDatePickerResult(int dayOfMonth, int month, int year) {
        String monthString = Integer.valueOf(month+1).toString();

        String toastDateMessage = getString(R.string.toastDeliveryMessage) + dayOfMonth + "/" + monthString + "/" + year;

        Toast.makeText(getApplicationContext(),toastDateMessage,Toast.LENGTH_LONG).show();
